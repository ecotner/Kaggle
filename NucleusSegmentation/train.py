...
MODEL_PATH = Path('./models/3/UNet3')
...
model.train(X_train, Y_train, X_val, Y_val, max_epochs=int(1e9), batch_size=16, learning_rate_init=2e-4, reg_param=0, learning_rate_decay_type='inverse', learning_rate_decay_parameter=10, keep_prob=[0.7, 0.8], early_stopping=True, save_path=MODEL_PATH, reset_parameters=True, val_checks_per_epoch=10, seed=SEED, data_on_GPU=False)
